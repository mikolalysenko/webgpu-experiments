...
(() => {
  ...
  // src/demos/particle-life.ts
  var NUM_SPECIES = 4;
  var NUM_PARTICLES = 1 << 13;
  var BG_COLOR = { r: 392e-5, g: 0.0863, b: 0.153, a: 1 };
  var PARTICLE_COLORS = [
    [0.969, 0.0902, 0.208],
    [0.255, 0.918, 0.831],
    [0.992, 1, 0.988],
  ...
  var PARTICLE_MASS = 4;
  var PARTICLE_SIZE = 1e-3;
  var COUPLING_COEFFS = new Float32Array(NUM_SPECIES * NUM_SPECIES);
